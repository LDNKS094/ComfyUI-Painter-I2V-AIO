    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input(
                    "motion_amplitude", default=1.3, min=1.0, max=2.0, step=0.05
                ),
    ...
    def execute(
        ...
        if start_image is not None:
            ...
            if motion_amplitude > 1.0:
                ...
                scaled_latent = (
                    base_latent + diff_centered * motion_amplitude + diff_mean
                )
                ...
                if color_protect and correct_strength > 0:
                    ...
                    if enhanced_brightness < orig_brightness * 0.92:
                        brightness_boost = min(
                            orig_brightness / (enhanced_brightness + 1e-6), 1.05
                        )
            ...
            positive_original = node_helpers.conditioning_set_values(
                positive_original,
                {
                    "concat_latent_image": concat_latent_image_original,
                    "concat_mask": mask,
                },
            )
        ...
        if clip_vision is not None:
            ...
            positive_original = node_helpers.conditioning_set_values(
                positive_original, {"clip_vision_output": clip_vision}
            )
            negative_original = node_helpers.conditioning_set_values(
                negative_original, {"clip_vision_output": clip_vision}
            )
